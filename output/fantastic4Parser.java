// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/baudo/Documents/TELECOM Nancy/Projet/Compilation/fantastic4.g 2014-06-11 12:20:19
...
public class fantastic4Parser extends DebugParser {
    ...
    public static final String[] ruleNames = new String[] {
        "invalidRule", "vardeclist", "expressionAtom", "mult", "funcdecl", 
        "writable", "comparatorOp", "addSubtractOp", "multiplyDivideOp", 
        "cste", "idenlist", "varsuitdecl", "prog", "sequence", "funcdeclist", 
        "instr", "returnable", "neg", "negExpression", "nextexpr", "exprlist", 
        "or", "expr", "typename", "puis", "and", "arg", "add", "arglist", 
        "comp"
    };
    ...
    public final fantastic4Parser.prog_return prog() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: vardeclist, instr, IDF, funcdeclist
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    // /Users/baudo/Documents/TELECOM Nancy/Projet/Compilation/fantastic4.g:15:1: vardeclist : varsuitdecl ( vardeclist )? -> varsuitdecl ( vardeclist )? ;
    public final fantastic4Parser.vardeclist_return vardeclist() throws RecognitionException {
        ...
        try {
            // /Users/baudo/Documents/TELECOM Nancy/Projet/Compilation/fantastic4.g:15:13: ( varsuitdecl ( vardeclist )? -> varsuitdecl ( vardeclist )? )
            dbg.enterAlt(1);
            ...
            // 15:39: -> varsuitdecl ( vardeclist )?
            {
                ...
                dbg.location(15,55);
                // /Users/baudo/Documents/TELECOM Nancy/Projet/Compilation/fantastic4.g:15:55: ( vardeclist )?
                if ( stream_vardeclist.hasNext() ) {
                    dbg.location(15,55);
    ...
    // /Users/baudo/Documents/TELECOM Nancy/Projet/Compilation/fantastic4.g:18:1: varsuitdecl : 'var' idenlist ':' typename ';' -> ^( typename idenlist ) ;
    public final fantastic4Parser.varsuitdecl_return varsuitdecl() throws RecognitionException {
        ...
        try {
            // /Users/baudo/Documents/TELECOM Nancy/Projet/Compilation/fantastic4.g:18:13: ( 'var' idenlist ':' typename ';' -> ^( typename idenlist ) )
            dbg.enterAlt(1);
            ...
            {
                dbg.location(18,50);
                // /Users/baudo/Documents/TELECOM Nancy/Projet/Compilation/fantastic4.g:18:50: ^( typename idenlist )
                {
                Object root_1 = (Object)adaptor.nil();
                dbg.location(18,52);
    ...
    public final fantastic4Parser.funcdecl_return funcdecl() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: vardeclist, 24, IDF, typename, arglist, instr
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt14) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: 28, 29, expr, instr, 30, instr
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
